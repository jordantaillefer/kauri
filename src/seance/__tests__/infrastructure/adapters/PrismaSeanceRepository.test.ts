...
describe("PrismaSeanceRepository", () => {
  ...
  describe("#recupererDetailParId", () => {
    it("quand la séance existe, doit remonter le détail de la séance", async () => {
      ...
      expect(resultDetailSeance.listeDetailExercice.at(0)?.ordre).toEqual(1)
      expect(resultDetailSeance.listeDetailExercice.at(0)?.tempsRepos).toEqual(45)
      expect(resultDetailSeance.listeDetailExercice.at(0)?.listeDetailSerie.at(0)?.id).toEqual("90afb02d-1c21-479a-a1bc-687c84b2704b")
      expect(resultDetailSeance.listeDetailExercice.at(0)?.listeDetailSerie.at(0)?.nombreRepetition).toEqual(10)
      ...
      expect(resultDetailSeance.listeDetailExercice.at(1)?.ordre).toEqual(2)
      expect(resultDetailSeance.listeDetailExercice.at(1)?.tempsRepos).toEqual(55)
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(0)?.id).toEqual("74dc9798-a52e-405c-8140-3bd3b4765e9a")
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(0)?.nombreRepetition).toEqual(12)
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(0)?.ordre).toEqual(1)
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(1)?.id).toEqual("27a093dc-995b-4ebd-b264-a3ae6d8cda69")
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(1)?.nombreRepetition).toEqual(14)
      expect(resultDetailSeance.listeDetailExercice.at(1)?.listeDetailSerie.at(1)?.ordre).toEqual(2)
    })
