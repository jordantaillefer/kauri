    ...
    <div className="bg-white">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="flex flex-1 justify-end">
            <Form
              ...
              method="post"
              action={`/authentication/${SocialsProvider.GOOGLE}`}
            >
      ...
      <main className="isolate">
        ...
        <div className="relative pt-14">
          ...
          >
            <div
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-emerald-100 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Ré-inventez votre vision du fitness
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Rejoignez une communauté de sportif pour atteindre vos objectifs.
                </p>
              </div>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <a href="/public" className="text-sm font-semibold leading-6 text-gray-900">
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
            <img
              ...
              src={ImageFitnessRoom}
              alt="d'une salle de sport"
            />
