...
export const ListeExerciceSeanceSideBar: FunctionComponent<{
  isOpen: boolean
  setIsOpen: Dispatch<SetStateAction<boolean>>
  exerciceSeances: ExerciceEntrainementContrat[]
}> = ({ isOpen, setIsOpen, exerciceSeances }) => {
  return (
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      <ListeExerciceSeance exerciceSeances={exerciceSeances} />
                    </div>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
